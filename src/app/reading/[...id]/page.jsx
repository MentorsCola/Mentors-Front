...
export default function Reading(props) {
  ...
  const checkLogin = () => {
    let Logined = localStorage.getItem("access");
    if (!Logined) {
      router.push("/");
    }
  };
  ...
  const Submit = async (e) => {
    ...
    await axios
      .post(
        `${process.env.NEXT_PUBLIC_URL}/comment/comments/${id}/`,
  ...
  const GetContent = async (e) => {
    await axios
      .get(`${process.env.NEXT_PUBLIC_URL}/board/boards/get/${id}/`, {
    ...
    <>
      ...
      <S.Background>
        <S.Main>
          ...
          <S.FuncButtons>
            ...
            >
              {liked ? (
                ...
                >
                  <path
                    d="M26 8C26 4.68667 23.2013 2 19.7493 2C17.1693 2 14.9533 3.50133 14 5.644C13.0467 3.50133 10.8307 2 8.24933 2C4.8 2 2 4.68667 2 8C2 17.6267 14 24 14 24C14 24 26 17.6267 26 8Z"
                    fill="#26400D"
                    stroke="#26400D"
                    stroke-width="2.5"
                ...
                >
                  <path
                    d="M28 11C28 7.68667 25.2013 5 21.7493 5C19.1693 5 16.9533 6.50133 16 8.644C15.0467 6.50133 12.8307 5 10.2493 5C6.8 5 4 7.68667 4 11C4 20.6267 16 27 16 27C16 27 28 20.6267 28 11Z"
                    stroke="#26400D"
                    stroke-width="2.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
          ...
          <S.Comments>
            <S.countComment>댓글 ({comments.length})</S.countComment>
